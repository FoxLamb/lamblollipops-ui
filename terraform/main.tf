# LambLollipops UI Infrastructure
# Standalone S3 + CloudFront static hosting for lamblollipops.com
...
terraform {
  ...
  backend "s3" {
    bucket = "fakedolphin-terraform-state-egykmlwl"
    key    = "lamblollipops-ui/terraform.tfstate"
    region = "us-east-1"
  }
}
...
resource "aws_cloudfront_origin_access_control" "frontend" {
  ...
  description                       = "OAC for LambLollipops UI frontend"
